...
async function sendVerificationKey(res, email) {
  ...
  let info = await transporter.sendMail({
    ...
    <a href="http://localhost:4200/#/forgotpassword?verificationcodevalid=true&useremail=${email}&token=${token}">http://localhost:4200/#/forgotpassword?${token}</a>
    <br /><br /><br /><i>
    ...
    for (var y = 0; y < excelDataName.length; y++) {
      ...
      conn.query(
        ...
        [
          ...
          excelDataEmail[y],
          hash,
          excelDataDesignation[y],
          excelDataStatus[y],
          excelDataDirectory[y],
          excelDataEmployee[y],
          excelDataLocation[y],
          excelDataDept[y],
          excelDataSam[y],
