...
@Component({
  selector: 'app-bankcompanylog',
  templateUrl: './bankcompanylog.component.html',
  styleUrls: ['./bankcompanylog.component.css']
})
export class BankcompanylogComponent implements OnInit {
