...
@Component({
  selector: 'app-changecompanyobject',
  templateUrl: './changecompanyobject.component.html',
  styleUrls: ['./changecompanyobject.component.css']
})
export class ChangecompanyobjectComponent implements OnInit {
