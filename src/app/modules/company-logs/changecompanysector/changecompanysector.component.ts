...
@Component({
  selector: 'app-changecompanysector',
  templateUrl: './changecompanysector.component.html',
  styleUrls: ['./changecompanysector.component.css']
})
export class ChangecompanysectorComponent implements OnInit {
