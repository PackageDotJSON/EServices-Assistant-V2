...
export class RequestLogService {
    ...
    getLogRequests() {
        return this.http.get(BASE_URL + REQUEST_LOG_API.GET_LOG_REQUESTS) as Observable<RequestLog>;
    }
    ...
    postLogRequest(email: string, message: string): Observable<any> {
        ...
        return this.http.post(BASE_URL + REQUEST_LOG_API.POST_LOG_REQUESTS, payload, {responseType: 'text'});
    }
    ...
    deleteLogRequest(email: string, message: string): Observable<any> {
        ...
        return this.http.delete(BASE_URL + REQUEST_LOG_API.DELETE_LOG_REQUESTS, {params});
    }
}